...
function Map:addCustomLayer(name, index)
  assert(not index,'Index should be nil to avoid potential error! Please review code before using index!')
...
function Map:draw(tx, ty, sx, sy)
  --assert(not (sx or sy),'Scale should be nil to avoid potential error! Please review code before using Scale!')
